...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val differencePrice = price - discountedPrice

        val difference = findViewById<TextView>(R.id.difference_label)
        difference.text = getString(R.string.difference, differencePrice)
    }
}
